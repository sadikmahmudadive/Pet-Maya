...
class AdminServiceManagerScreen extends StatefulWidget {
  ...
  @override
  State<AdminServiceManagerScreen> createState() =>
          ...
          Expanded(
            child: vets.isEmpty
                ? const EmptyState(
                    ...
                    message: 'Add your first clinical provider.',
                  )
                : ListView.builder(
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text(
                widget.vet == null ? 'ONBOARD SERVICE' : 'EDIT SERVICE INFO',
                style: const TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w900,
                  letterSpacing: 1,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: _input('CONSULTATION FEE', _priceController),
                      ),
                      const SizedBox(width: 16),
                  ...
                  Wrap(
                    spacing: 8,
                    children:
                        ['VETERINARIAN', 'GROOMING', 'BOARDING', 'SHELTER']
                            .map(
                              (t) => ChoiceChip(
                                label: Text(
                                  t,
                                  style: TextStyle(
                                    fontSize: 10,
                                    fontWeight: FontWeight.w800,
                                    color: _tag == t ? Colors.white : null,
                                  ),
                                ),
                                selected: _tag == t,
                                selectedColor: AppColors.primary,
                                onSelected: (val) {
                                  if (val) setState(() => _tag = t);
                                },
                              ),
                            )
                            .toList(),
