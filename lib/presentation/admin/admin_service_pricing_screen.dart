...
class AdminServicePricingScreen extends StatefulWidget {
  ...
  @override
  State<AdminServicePricingScreen> createState() =>
          ...
          Expanded(
            child: filteredVets.isEmpty
                ? const EmptyState(
                    ...
                    message:
                        'Register service providers to manage their pricing.',
                  )
                : ListView.builder(
                              ...
                              child: Row(
                                children: [
                                  CircleAvatar(
                                    ...
                                    backgroundImage: vet.photoUrl != null
      ...
      builder: (ctx) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Update official pricing for ${vet.name}',
              style: const TextStyle(
                color: Colors.grey,
                ...
                onPressed: () {
                  ...
                  if (newPrice.isNotEmpty) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          'Price updated to $newPrice for ${vet.name}! 💰',
                        ),
