...
class _AdminBlogManagerScreenState extends State<AdminBlogManagerScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final pendingCount = blogs
        .where((b) => !b.isApproved && b.status != 'APPROVED')
        .length;
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                _buildStatusTab(
                  'APPROVED',
                  'Live (${blogs.length - pendingCount})',
                  isDark,
                ),
              ],
            ),
  ...
  void _confirmDelete(
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'Are you sure you want to permanently remove "${blog.title}"? This cannot be undone.',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(ctx),
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Article deleted from community feed.'),
                  backgroundColor: AppColors.dangerRed,
                ),
              );
            },
