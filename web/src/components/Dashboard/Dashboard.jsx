      ...
      <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', marginBottom: '16px', fontSize: '11.5px', color: '#160F0C' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <span>Pet Maya Clinical Center, Banani 11, Dhaka</span>
                </div>
              </div>
                ...
                <div style={{
                  ...
                  <div style={{ textAlign: 'right' }}>
                    ...
                    <div
                      ...
                      style={{ fontSize: '9.5px', color: '#0D9488', fontWeight: 600, cursor: 'pointer' }}
                    >
                      + Visit Cold-Chain Auto
                    </div>
                  </div>
                </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', marginBottom: '20px' }}>
            {[
              {
                title: 'AI Dental Plaque & Gingiva Vision Scan',
              ...
              {
                title: 'Comprehensive Serum Biochemistry & Electrolyte Panel',
                badge: 'All Normal (14)',
                desc: 'BUN, Creatinine, ALT, ALP, and Blood Glucose verified within optimal canine homeostatic thresholds.',
                timestamp: 'Oct 12, 2025',
                attestation: 'Maya Central Pathology Lab',
                icon: FlaskConical
              },
              {
                title: 'Care Shop Auto-Formulary Dispatched',
                badge: 'Track #DH-9810-04',
                desc: 'Quarterly replenishment: Purina Pro Plan NeuroCare (14kg) + Nordic Naturals Omega-3 Wild Anchovy Oil.',
                timestamp: 'Oct 04, 2025',
                attestation: 'Delivered to Banani Residence',
                icon: Truck
              },
              {
                title: 'Routine Weight Check-in: 28.4 kg',
                badge: 'Body Condition Score: 5/9',
                desc: 'Logged via Pet Maya Connected Scale mat. Zero muscular atrophy or adipose variance.',
                timestamp: 'Sep 28, 2025',
                attestation: 'Home Smart Mat Sync',
                icon: Scale
              }
            ].map((event, i) => {
